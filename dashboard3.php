  ...
  <nav>
    ...
    <ul class="admin-menu">
      <li class="menu-heading">
        <h3>POLICE STATION DASHBOARD</h3>
      </li>
      <li>
...
<section class="page-content">
  <section class="search-and-user">
    ...
    <div class="admin-profile">
      <span class="greeting">Hello police</span>
  ...
  <footer class="page-footer">
    <small>Made with <span>❤</span> by <a href="index.php" target="_blank">criminal record management system</a>
    </small>
  </footer>
</section>
