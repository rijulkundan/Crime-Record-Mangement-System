		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">ADD REVIEW PANEL MEMBER DETAILS</h4>
							<form action ="panel.php" method="POST" class="my-signup-validation" novalidate="">
						...
						<div class="form-group">
								...
								<div class="form-group">
									...
									<input id="height" type="height" class="form-control" name="height" value="" required autofocus>
									<div class="invalid-feedback">
										Email is invalid
									</div>
								</div>
								...
								<div class="form-group">
									...
									<input id="weight" type="weight" class="form-control" name="weight" value="" required autofocus>
									<div class="invalid-feedback">
										Email is invalid
									</div>
								</div>
