...
<header class="page-header">
  <nav>
    <a href="#0">
      <img class="logo" src="img/crime.jpg" alt=" logo">
    </a>
    ...
    <ul class="admin-menu">
      <li class="menu-heading">
        <h3>REVIEW PANEL DASHBOARD</h3>
      </li>
      <li>
        <a href="viewpolice.php">
          <svg>
            <use xlink:href="#pages"></use>
       </svg>
          <span >POLICE STATION</span></a>
        </a>
      </li>
      <li>
        <a href="firr.php">
...
<section class="page-content">
  <section class="search-and-user">
    ...
    <div class="admin-profile">
      <span class="greeting">Hello review panel member</span>
  ...
  <footer class="page-footer">
    <small>Made with <span>❤</span> by <a href="index.php" target="_blank">crime record management system</a>
    </small>
  </footer>
</section>
